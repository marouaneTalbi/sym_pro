 ...
 */
final class Version20210415081147 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE auto ADD CONSTRAINT FK_66BA25FA12469DE2 FOREIGN KEY (category_id) REFERENCES categorie (id)');
